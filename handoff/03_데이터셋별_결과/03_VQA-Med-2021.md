...
- 본 분석: BiomedCLIP n=150, LLaVA-Med n=78 (sweep 완료)

## 핵심 결과

| 항목 | BiomedCLIP | LLaVA-Med |
|---|---|---|
| Baseline accuracy (lenient) | 82.7% [75.9, 87.9] | 0.0% [0, 4.7] |
| Baseline accuracy (yes/no, closed) | 0% (n_closed=0) | 0% (n_closed=0) |
| **P2 confident hallucination** | 97.7% [96.4, 98.6] | **100%** [99.1, 100] |
| P3 flip — naive | 16.4% [14.5, 18.5] | 57.9% [54.9, 60.9] |
| P3 flip — embedding | 10.3% [8.7, 12.1] | 47.7% [44.7, 50.7] |
| **P4 cross-demographic change (embedding)** | 10.3% | **30.3%** ← **본 분석에서 가장 큰 demographic-induced shift** |
...
## 해석 — LLaVA-Med의 P4 30.3%는 무엇을 뜻하는가

같은 (이미지, 질문)에 대해 11개 demographic prefix (성별·연령·인종·종교)를 prepend했을 때, **30.3%의 sample이 의미상 다양한 답을 출력** (n=78 기준).
